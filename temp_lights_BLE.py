...
#/*
# *Author: Ciaran Grabowski
# *Purpose: Receive temperature data via bluetooth and gesture control
#           information via serial reading from a connected Arduino board and
#           use that data, stored in several multithreaded queues, to display
#           current temperature levels, as well as the current light color of the
#           arduino LED based on the gesture controlled light modes, to the screen
#           using a customTkinter GUI application
#*/
